...
ARDUINO_PATH:=/home/sgithens/code/arduino-0023/
...
EXTRA_LIB_DIR:=/home/sgithens/code/arduinolibs/
EXTRA_DIRS=$(EXTRA_LIB_DIR)AF_SDLog/
EXTRA_DIRS+=$(EXTRA_LIB_DIR)NewSoftSerial/
...
#=== identify user files ===
PDESRC:=$(shell ls *.pde)
# SWG Changing this variable from pde to c
#PDESRC:=$(shell ls *.c)
